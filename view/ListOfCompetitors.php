...
include_once '../Controller/ListOfCompetitorsCtrl.php';
...
if (isset($_SESSION['connect']) && $_SESSION['connect'] == 'OK' && in_array($_SESSION['access'], $Function)) {
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-6 ">
                <h1><?= isset($message) ? $message : 'Concurant inscrit sur '+ $NameofCompet  ?></h1>
            </div>
            <div class="col-lg-3">
                <img src="../assets/img/imgPresentation/logo.jpg" alt=""/>
            </div>
            ...
            <div class="col-lg-6 centralColumm">
                <div>
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            foreach ($DisplayListCompetitorsByCompetition as $RegisteredForCompetition) {
                                ?>
                                <tr>
                                    <td><?= $RegisteredForCompetition->Name?></td>
                                    <td><?= $RegisteredForCompetition->Firstname?></td>
