...
//fonction de connexion a ma base de donnéer 
    ...
    public function DisplayOfAllLicenses() {
        $query = 'SELECT `0108asap_functionsummary`.`LicenceNumber` AS `SecondaryLicense`, `0108asap_functions`.`TypeOfLicence`, `0108asap_functionsummary`.`id_0108asap_member` AS `IdMembers` '
